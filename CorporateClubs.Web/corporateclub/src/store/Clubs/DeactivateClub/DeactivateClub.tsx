...
import './DeactivateClub.scss';
import { Icon } from 'react-icons-kit'
import {ic_close} from 'react-icons-kit/md/ic_close'
import {BrowserRouter as Router,Switch,Route,Link} from 'react-router-dom';
import { getNativeProps } from '@uifabric/utilities';
import {connect} from 'react-redux';
import {deactivateClub} from '../Actions/ClubActions';

interface Iprops{
    name?:string;
}
class DeactivateClub extends React.Component<any,any> {
    ...
    return(
        ...
        <div className="DeactivateClub" >
            <header className="DeactivateClub_head">
        <text>Deactivate {this.props.clubTitle}</text>
        ...
        <div id="content">
            ...
            <ul>
                <li>All the Club memebers would not  be able to see the club and comunicate through it..</li>
                <li>This club will not be shown to any users.</li>
            </ul>
            <p>Reason:</p>
...
export default connect()(DeactivateClub);