...
class  AddClubs extends React.Component<any,any>{
    ...
    {
        super(props);
        this.state={name:"",description:"",selectedAdmins:{},selectedUsers:{},clubtype:"",displayUsers:this.props.users,displayAdmins:this.props.users,usersSelection:"",adminsSelection:"",isToggled:true,clubType:"-Open Club",error:"",image:""};
