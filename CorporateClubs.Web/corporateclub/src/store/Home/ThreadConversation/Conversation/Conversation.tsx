...
import IMsgWithAttach, { IPrivateMsgWithAttach } from '../../../../models/IMsgWithAttach';
     ...
     sendMessage=(event)=>{
         ...
         if(this.state.files.length!=0){
            ...
            var blob = new Blob([JSON.stringify(conversation)], {type : 'application/json'});
             ...
             axios.post('http://localhost:3333/api/conversations/uploadattachmentstochat/'+this.props.connectedUserID+'/'+this.props.loggedUser.userID,
         ...
         return(
             <div className="chatScreen">
                 <div className="titleBar">
                     <div className="title">{this.props.userMessages.length!=0?(this.props.userMessages[0].connectedUserName):(<span></span>)}</div>
                     <nav>
                 ...
                 <div className="chatDisplayArea">
                       ...
                       {
                           this.state.userMessages==undefined?(this.props.userMessages.map(message=>message.userID==this.props.loggedUser.userID?
                                                ...
                                                :(this.state.userMessages.map(message=>message.userID==this.props.loggedUser.userID?
